...
class Rating(TimeStampedUUIDModel):
    ...
    agent = models.ForeignKey(Profile, verbose_name="Agent to be rated",
                              related_name="agent_review", on_delete=models.SET_NULL, null=True)
    rating = models.IntegerField(verbose_name="Rating", default=0, choices=Range.choices,
                                 help_text="1=Poor, 2=Fair 3=Good 4=Vey good 5=Excellent")
